...
const ch4 = [
  ...
  p("ระบบ PT-Medical System ถูกนำไปทดสอบใช้งานจริงใน 2 หน่วยปฏิบัติการแพทย์ ตั้งแต่ปลายเดือนมีนาคมถึงกลางเดือนเมษายน 2569 (ระยะเวลาประมาณ 3 สัปดาห์) โดย บจก.ทรัพย์วิไล เมดิคอล ใช้ระบบทั้ง Transport และ First Aid ส่วน The Good Ambulance ใช้เป็นหลักในงาน Transport ซึ่งมีปริมาณเคสมากกว่า ผลการใช้งานสรุปได้ดังตารางที่ 1"),
  ...
  new Table({
    ...
    rows: [
      ...
      new TableRow({ children: [
        makeCell("Transport Cases", { width: 3000 }),
        makeCell("4", { center: true, width: 2013 }),
        makeCell("26", { center: true, width: 2013 }),
        makeCell("30", { center: true, width: 2000 }),
      ]}),
      new TableRow({ children: [
        makeCell("Digital Consent", { width: 3000 }),
        makeCell("4", { center: true, width: 2013 }),
        makeCell("1", { center: true, width: 2013 }),
        makeCell("5", { center: true, width: 2000 }),
      ]}),
      new TableRow({ children: [
        makeCell("First Aid Events", { width: 3000 }),
        makeCell("3", { center: true, width: 2013 }),
        makeCell("14", { center: true, width: 2013 }),
        makeCell("17", { center: true, width: 2000 }),
      ]}),
      new TableRow({ children: [
        makeCell("First Aid Patients", { width: 3000 }),
        makeCell("0", { center: true, width: 2013 }),
        makeCell("74", { center: true, width: 2013 }),
        makeCell("74", { center: true, width: 2000 }),
      ]}),
    ]
  }),

  p("จากตารางที่ 1 พบว่า The Good Ambulance มีปริมาณเคส Transport สูงกว่า (26 เคส) เนื่องจากเป็นหน่วยที่ให้บริการรถพยาบาลฉุกเฉินเป็นหลัก ในขณะที่ บจก.ทรัพย์วิไล เมดิคอล มีปริมาณเคส Transport น้อยกว่า (4 เคส) แต่มี First Aid Events 3 เหตุการณ์ เนื่องจากมีงานอีเวนต์ที่ให้บริการในช่วงทดสอบ ส่วน Digital Consent มีการใช้งาน 5 ฉบับ เนื่องจากเป็นฟีเจอร์ใหม่ที่ทีมกู้ชีพยังไม่คุ้นเคย จำเป็นต้องมีการอบรมและสร้างความเข้าใจเพิ่มเติม"),
  ...
  new Table({
    ...
    rows: [
      ...
      new TableRow({ children: [
        makeCell("รวม 30 เคส (ช่วงทดสอบ)", { width: 3500 }),
        makeCell("\u226560 แผ่น", { center: true, width: 2763 }),
        makeCell("0 แผ่น", { center: true, width: 2763 }),
      ]}),
    ]
  }),

  p("ในช่วงทดสอบ 3 สัปดาห์ ระบบช่วยลดการใช้กระดาษได้อย่างน้อย 60 แผ่น หากขยายการใช้งานเป็นระยะยาว คาดว่าจะลดการใช้กระดาษได้หลายร้อยแผ่นต่อปีสำหรับแต่ละหน่วยปฏิบัติการ"),
...
const ch5 = [
  ...
  p("\u2022 ลดการใช้กระดาษอย่างน้อย 2 แผ่นต่อเคส รวม 60 แผ่นในช่วงทดสอบ 3 สัปดาห์", { noIndent: true }),
  p("จากการทดสอบใช้งานจริงใน 2 หน่วยปฏิบัติการเป็นเวลา 3 สัปดาห์ มีการบันทึกเคส Transport 30 เคส, First Aid Events 17 เหตุการณ์ และผู้ป่วย First Aid 74 ราย แสดงให้เห็นว่าระบบสามารถใช้งานได้จริงในสถานการณ์ปฏิบัติงานจริงของทีมกู้ชีพ"),
  ...
  p("2) ระยะเวลาทดสอบยังสั้น (3 สัปดาห์) อาจยังไม่เพียงพอสำหรับการประเมินผลระยะยาว โดยเฉพาะในด้านความเสถียรของระบบ การรับมือกับข้อมูลจำนวนมาก และพฤติกรรมการใช้งานของผู้ใช้เมื่อคุ้นเคยกับระบบมากขึ้น", { noIndent: true }),
  p("3) จำนวนหน่วยปฏิบัติการที่ทดสอบมีเพียง 2 หน่วย ซึ่งเป็นหน่วยภาคเอกชนทั้งคู่ ควรขยายการทดสอบไปยังหน่วยปฏิบัติการที่หลากหลายมากขึ้น รวมถึงหน่วยของมูลนิธิและองค์กรปกครองส่วนท้องถิ่น เพื่อเพิ่มความน่าเชื่อถือของผลการศึกษา", { noIndent: true }),
  p("4) Digital Consent ยังมีอัตราการใช้งานต่ำ (5 จาก 30 เคส) เนื่องจากทีมกู้ชีพยังไม่คุ้นเคยกับระบบใหม่ ต้องมีการอบรมและสร้างความเชื่อมั่นเพิ่มเติม", { noIndent: true }),
