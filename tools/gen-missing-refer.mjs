...
const PROMPT =
  ...
  '5. ชื่อโรงพยาบาล: คงรูปตามเอกสาร — ถ้าเป็นตัวย่อให้คงตัวย่อไว้ ห้ามขยายเป็นชื่อเต็มเอง (กันเดาผิด + ประหยัด token). ยกเว้นกรณีเดียว: ถ้าเอกสารเขียน "สปร" หรือ "รพ.สปร" ให้เขียนเป็น "รพ.สวรรค์ประชารักษ์". ถ้าชื่อ/ตัวย่ออ่านไม่ชัดหรือไม่มั่นใจ ห้ามเดาเด็ดขาด — ให้เขียนเป็น "โรงพยาบาลต้นทาง" หรือ "โรงพยาบาลปลายทาง" ตามบทบาทในเอกสารแทน (ถ้าระบุบทบาทไม่ได้ ให้เขียนแค่ "โรงพยาบาล") · ส่วนชื่อบุคคล/สถานที่อื่นที่อ่านไม่ชัด ให้เขียน "(อ่านไม่ชัด)"\n' +
